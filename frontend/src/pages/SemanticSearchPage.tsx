  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4 shadow-xs hover:border-primary/40 transition-colors">
      ...
      <div className="mt-2 flex items-center gap-2">
        ...
        <Link
          to={`/cases/${result.case_id}`}
          aria-label={`Open case ${result.title || result.citation}`}
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-6">
      ...
      <form
        ...
        role="search"
        aria-label={t("semantic_search.title", { defaultValue: "Semantic Search" })}
        className="space-y-3"
      >
        ...
        <div
          role="group"
          aria-label={t("semantic_search.model_label", { defaultValue: "Model:" })}
          className="flex items-center gap-3 text-xs text-muted-text"
        >
      ...
      {/* Results area */}
      <section
        aria-label={t("semantic_search.results_region_label", {
      ...
      >
        ...
        {isFetching && (
          <div
            className="space-y-3"
            role="status"
            aria-label={t("semantic_search.searching", {
